...
import { MdDashboard, MdNoteAdd  , MdInsertChart,MdAccountCircle } from "react-icons/md";
import { useState } from "react";

export const Sidebar = ({ actived, iconActive ,collapse,highlight}) => {
  ...
  return (
      <ul className="navbar-nav bg-primary sidebar sidebar-dark">
        <div className="sidebar-brand d-flex align-items-center justify-content-center">
          ...
          <div className="sidebar-brand-text fs-5 fw-bold">E<span className="color fs-5 fw-bold">C</span>MS <br/>HR Management</div>
        </div>
        ...
        <li className={"nav-item" + (isCollapsed || actived === "withdraw" || actived === "reim" ? " active" : "")}>
          <Link
          ...
          >
           <div
              className="sidebar-icon-container"
              style={{
                opacity:isCollapsed || actived === "withdraw" || actived === "reim" ? 1 : 0.35,
              }}
            >
              <MdNoteAdd 
                className="sidebar-icon"
                style={isCollapsed || actived === "withdraw" || actived === "reim" ? iconActive : {}}
              />
            </div>
          ...
          >
            <div className="bg-white py-2 collapse-inner rounded">
              ...
              <Link className="collapse-item" to="/hr/withdraw/requests" style={actived === "withdraw" ? highlight : {}}>
                ถอนคอร์สอบรม
              </Link>
              <Link className="collapse-item" to="/hr/reimbursement/requests" style={actived === "reim" ? highlight : {}}>
                เบิกค่าอบรม
              </Link>
            </div>
          </div>
